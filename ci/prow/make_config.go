...
func main() {
	...
	flag.StringVar(&coverageDockerImage, "coverage-docker", *dockerImagesBase + "/coverage:latest", "Docker image for coverage tool")
	flag.StringVar(&prowTestsDockerImage, "prow-tests-docker", *dockerImagesBase + "/prow-tests:stable", "prow-tests docker image")
