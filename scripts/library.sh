...
function update_licenses() {
  ...
  local dir=$2
  shift
  run_go_tool github.com/google/go-licenses go-licenses save "${dir}" --save_path="${dst}" --force || { echo "--- FAIL: go-licenses failed to update licenses"; return 1; }
...
function check_licenses() {
  ...
  run_go_tool github.com/google/go-licenses go-licenses check "${REPO_ROOT_DIR}/..." || { echo "--- FAIL: go-licenses failed the license check"; return 1; }
}
