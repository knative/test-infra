...
function update_licenses() {
  ...
  local dst=$1
  shift
  run_go_tool dep-collector github.com/knative/test-infra/tools/dep-collector $@ > ./${dst}
}
...
function check_licenses() {
  ...
  run_go_tool dep-collector github.com/knative/test-infra/tools/dep-collector -check $@
}
