...
```sh
$ go run cleanup.go --project-resource-yaml config/prow/build-cluster/boskos/boskos_resources.yaml --days-to-keep-images 90 --hours-to-keep-clusters 24`
```
...
[config/prow/build-cluster/boskos/boskos_resources.yaml](/config/prow/build-cluster/boskos/boskos_resources.yaml)
