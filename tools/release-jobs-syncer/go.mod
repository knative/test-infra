module knative.dev/test-infra/tools/release-jobs-syncer
...
require (
	...
	istio.io/test-infra/tools/prowgen v0.0.0-20220323220741-60bbc355b6e9
...
require (
	...
	k8s.io/test-infra v0.0.0-20220110151312-600d25dbe068 // indirect
